...
For this workshop we will outline three different workflows for creating reproducible research projects with R combined with other tools. We have named these workflows as follows: 1. Rstudio project to Zenodo pipeline 2. Containerization with Docker 3. Version control with Git
