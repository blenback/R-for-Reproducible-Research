...
-   Click the green 'create repository' button
    ...
    ![Setting up the repository](assets/images/git_ex1.png){fig-align="left" width="50%"}
...
-   Click 'Create project'
    ...
    ![Linking repository to R-Studio](assets/images/git_ex2.png){fig-align="left" width="50%"}
...
```         
![R-Studio new project session with git link](assets/images/git_ex3.png){fig-align="left" width="50%"}
```
...
```         
![Adding data to project](assets/images/git_ex4.png){fig-align="left" width="50%"}
```
...
-   Save the file.
    ...
    ![Edit README.md](assets/images/git_ex5.png){fig-align="left" width="50%"}

### Step 6: Edit the git.ignore file
...
-   Open the .gitignore file and add '.html' in a new line and save the file
    ...
    ![Edit .gitignore](assets/images/git_ex6.png){fig-align="left" width="50%"}
...
-   click 'Push' in the Git tab, a window will pop up showing the interface with the remote system and details of the upload.
    ...
    !Commit changes\](assets/images/git_ex7.png){fig-align="left" width="50%"}
