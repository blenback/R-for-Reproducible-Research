...
- But writing comprehensive documentation that covers all aspects of projects according to a strict convention is time-consuming

- Suggested solution in the R research community to adopt the *research as package* approach, i.e. creating your project as an R-package which has a strict set of conventions for documentation [@marwick2018].

- This is a viable approach for those who are familiar with R-packages but is arguably not the best for all projects and users.
