...
-   The renv.lock file records exact versions of all installed packages, allowing consistent reproducibility.

-   This feature is especially useful for transferring projects between machines, maintaining a controlled environment.

-   It centralizes the environment management within the project folder, avoiding conflicts with global R libraries.
:::
### renv Workflow
