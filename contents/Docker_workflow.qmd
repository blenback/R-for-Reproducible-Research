...
need to start by creating a `Dockerfile` and, as mentioned above this
starts with a base image. In our case this base image must logically
...
can be done manually (See a good R-focused tutorial here)

### Practical example with dockerfiler package

Manually creating the Dockerfile:
https://colinfay.me/docker-r-reproducibility/

The main advantages of using Docker within your development environment
are:
